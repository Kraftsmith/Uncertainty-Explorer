...
const deliveryPractices = [
    ...
    },
    {
        ...
        primaryArea: "Hybrid",
        secondaryArea: "Agile",
        description: "Management approach focusing on achieving strategic objectives through clearly defined and measurable goals.",
        benefits: "Aligns team efforts with business objectives, provides clear direction, enables performance measurement"
    },
    {
    ...
    },
    {
        ...
        primaryArea: "Agile",
        secondaryArea: "Agile",
        description: "Standard agile practice where each sprint produces a potentially shippable product increment.",
        benefits: "Ensures continuous value delivery, maintains focus on working software, enables rapid feedback"
    },
    {
    ...
    },
    {
        ...
        primaryArea: "Hybrid",
        secondaryArea: "Hybrid",
        description: "Daily Standup is a brief, focused meeting where team members align on progress, share status and address obstacles, discussing what was done yesterday, plans for today, and any issues, with some focusing on structured milestones and others on iterative progress. Primary Focus: Daily Standup: Individual Status & Alignment. Team members share what they have done, what they will do, and any blockers they face. The focus is on keeping the team aligned and aware of each other's work. Daily Scrum: Progress Toward the Sprint Goal. The entire focus is on inspecting progress toward the single, shared Sprint Goal. The team asks, 'Are we on track to meet our goal, and what is the most important thing we can do today to get there?' Driving Question: Daily Standup: 'What is my individual progress and what are my impediments?' Daily Scrum: 'How can we, as a team, best adapt our plan for the next 24 hours to achieve the Sprint Goal?' Context: Daily Standup: Can be used in any project or team structure (Kanban, XP, general project management) that values quick, daily sync-ups. Daily Scrum: A formal, mandatory event for teams practicing the Scrum framework. Aspect: Outcome: Daily Standup: Team synchronization and obstacle identification. Daily Scrum: A revised plan for the day's work. The team adapts its plan based on the discussion to optimize the chances of meeting the Sprint Goal. Both meetings are short, daily, and intended to synchronize the team, the Daily Scrum has a laser focus on the collective Sprint Goal. A general Daily Standup can sometimes become a series of individual status reports, whereas a well-run Daily Scrum is a strategic planning session for the next 24 hours, all in service of one objective.",
        benefits: "Improves team communication, identifies impediments early, maintains project alignment"
    },
    {
        name: "Daily Scrum",
        primaryArea: "Agile",
